            ...
            <form method="POST" action="{{ route('announcements.store') }}">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="meeting_date" name="meeting_date" class="form-control" value="{{ old('meeting_date') }}">
                        @error('meeting_date') <div class="field-error">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group">
                        <label for="expired_at">Batas Waktu Pengumuman (Opsional)</label>
                        <input type="datetime-local" id="expired_at" name="expired_at" class="form-control" value="{{ old('expired_at') }}">
                        <div class="form-hint"><i class="fas fa-info-circle"></i> Setelah waktu ini, pengumuman tidak tampil ke karyawan.</div>
